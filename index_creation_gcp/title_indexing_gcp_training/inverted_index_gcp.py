...
class MultiFileWriter:
    ...
    def upload_to_gcp(self):
        ...
        blob = self.bucket.blob(f"postings_gcp_title_training/{file_name}")
...
class InvertedIndex:  
    ...
    def _upload_posting_locs(bucket_id, posting_locs, bucket_name):
        ...
        blob_posting_locs = bucket.blob(f"postings_gcp_title_training/{bucket_id}_posting_locs.pickle")
